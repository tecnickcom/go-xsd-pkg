...
//	TQNames declares a String containing a whitespace-separated list of TQName values. This Values() method creates and returns a slice of all elements in that list, typed as xsdt.Name.
func (me TQNames) ValuesXsdtName() (list []xsdt.Name) {
	svals := xsdt.ListValues(string(me))
...
func (me TvalidationType) IsPreserve() bool { return me.String() == "preserve" }

//	Returns true if the value of this enumerated TvalidationType is "strip".
func (me TvalidationType) IsStrip() bool { return me.String() == "strip" }
...
func (me TvalidationType) IsStrict() bool { return me.String() == "strict" }

//	Returns true if the value of this enumerated TvalidationType is "lax".
func (me TvalidationType) IsLax() bool { return me.String() == "lax" }
...
func (me TyesOrNo) IsYes() bool { return me.String() == "yes" }

//	Returns true if the value of this enumerated TyesOrNo is "no".
func (me TyesOrNo) IsNo() bool { return me.String() == "no" }
...
//	TprefixList declares a String containing a whitespace-separated list of TprefixOrDefault values. This Values() method creates and returns a slice of all elements in that list, typed as xsdt.String.
func (me TprefixList) ValuesXsdtString() (list []xsdt.String) {
	svals := xsdt.ListValues(string(me))
...
//	If the WalkHandlers.TversionedElementType function is not nil (ie. was set by outside code), calls it with this TversionedElementType instance as the single argument. Then calls the Walk() method on 1/2 embed(s) and 0/0 field(s) belonging to this TversionedElementType instance.
...
//	If the WalkHandlers.TxsdElement function is not nil (ie. was set by outside code), calls it with this TxsdElement instance as the single argument. Then calls the Walk() method on 0/7 embed(s) and 0/0 field(s) belonging to this TxsdElement instance.
...
//	If the WalkHandlers.TxsdValueOf function is not nil (ie. was set by outside code), calls it with this TxsdValueOf instance as the single argument. Then calls the Walk() method on 0/4 embed(s) and 0/0 field(s) belonging to this TxsdValueOf instance.
...
//	If the WalkHandlers.TtextElementBaseType function is not nil (ie. was set by outside code), calls it with this TtextElementBaseType instance as the single argument. Then calls the Walk() method on 1/1 embed(s) and 0/0 field(s) belonging to this TtextElementBaseType instance.
...
type TxsdText struct {
	TtextElementBaseType

	XsdGoPkgHasAttr_DisableOutputEscaping_TyesOrNo_No
}

//	If the WalkHandlers.TxsdText function is not nil (ie. was set by outside code), calls it with this TxsdText instance as the single argument. Then calls the Walk() method on 1/2 embed(s) and 0/0 field(s) belonging to this TxsdText instance.
func (me *TxsdText) Walk() (err error) {
	if fn := WalkHandlers.TxsdText; me != nil {
		...
		if err = me.TtextElementBaseType.Walk(); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
			return
		}
		if fn != nil {
			if err = fn(me, false); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
...
//	If the WalkHandlers.TxsdWhen function is not nil (ie. was set by outside code), calls it with this TxsdWhen instance as the single argument. Then calls the Walk() method on 0/2 embed(s) and 0/0 field(s) belonging to this TxsdWhen instance.
...
//	If the WalkHandlers.TxsdComment function is not nil (ie. was set by outside code), calls it with this TxsdComment instance as the single argument. Then calls the Walk() method on 0/2 embed(s) and 0/0 field(s) belonging to this TxsdComment instance.
...
//	If the WalkHandlers.TxsdCopy function is not nil (ie. was set by outside code), calls it with this TxsdCopy instance as the single argument. Then calls the Walk() method on 0/6 embed(s) and 0/0 field(s) belonging to this TxsdCopy instance.
...
//	If the WalkHandlers.TxsdNamespace function is not nil (ie. was set by outside code), calls it with this TxsdNamespace instance as the single argument. Then calls the Walk() method on 0/3 embed(s) and 0/0 field(s) belonging to this TxsdNamespace instance.
...
//	If the WalkHandlers.TxsdWithParam function is not nil (ie. was set by outside code), calls it with this TxsdWithParam instance as the single argument. Then calls the Walk() method on 0/5 embed(s) and 0/0 field(s) belonging to this TxsdWithParam instance.
...
//	If the WalkHandlers.TxsdSequence function is not nil (ie. was set by outside code), calls it with this TxsdSequence instance as the single argument. Then calls the Walk() method on 2/3 embed(s) and 0/0 field(s) belonging to this TxsdSequence instance.
...
//	If the WalkHandlers.TxsdAttribute function is not nil (ie. was set by outside code), calls it with this TxsdAttribute instance as the single argument. Then calls the Walk() method on 0/7 embed(s) and 0/0 field(s) belonging to this TxsdAttribute instance.
...
//	If the WalkHandlers.TxsdDocument function is not nil (ie. was set by outside code), calls it with this TxsdDocument instance as the single argument. Then calls the Walk() method on 0/3 embed(s) and 0/0 field(s) belonging to this TxsdDocument instance.
...
//	If the WalkHandlers.TxsdSort function is not nil (ie. was set by outside code), calls it with this TxsdSort instance as the single argument. Then calls the Walk() method on 0/8 embed(s) and 0/0 field(s) belonging to this TxsdSort instance.
...
//	If the WalkHandlers.TxsdForEachGroup function is not nil (ie. was set by outside code), calls it with this TxsdForEachGroup instance as the single argument. Then calls the Walk() method on 2/9 embed(s) and 0/0 field(s) belonging to this TxsdForEachGroup instance.
...
//	If the WalkHandlers.TxsdForEach function is not nil (ie. was set by outside code), calls it with this TxsdForEach instance as the single argument. Then calls the Walk() method on 2/4 embed(s) and 0/0 field(s) belonging to this TxsdForEach instance.
...
//	If the WalkHandlers.TxsdMessage function is not nil (ie. was set by outside code), calls it with this TxsdMessage instance as the single argument. Then calls the Walk() method on 0/3 embed(s) and 0/0 field(s) belonging to this TxsdMessage instance.
...
func (me Tlevel) IsSingle() bool { return me.String() == "single" }

//	Returns true if the value of this enumerated Tlevel is "multiple".
func (me Tlevel) IsMultiple() bool { return me.String() == "multiple" }

//	Returns true if the value of this enumerated Tlevel is "any".
func (me Tlevel) IsAny() bool { return me.String() == "any" }
...
//	If the WalkHandlers.TxsdNumber function is not nil (ie. was set by outside code), calls it with this TxsdNumber instance as the single argument. Then calls the Walk() method on 1/12 embed(s) and 0/0 field(s) belonging to this TxsdNumber instance.
...
//	If the WalkHandlers.TxsdCopyOf function is not nil (ie. was set by outside code), calls it with this TxsdCopyOf instance as the single argument. Then calls the Walk() method on 1/5 embed(s) and 0/0 field(s) belonging to this TxsdCopyOf instance.
...
//	If the WalkHandlers.TxsdResultDocument function is not nil (ie. was set by outside code), calls it with this TxsdResultDocument instance as the single argument. Then calls the Walk() method on 0/21 embed(s) and 0/0 field(s) belonging to this TxsdResultDocument instance.
...
//	If the WalkHandlers.TxsdVariable function is not nil (ie. was set by outside code), calls it with this TxsdVariable instance as the single argument. Then calls the Walk() method on 0/4 embed(s) and 0/0 field(s) belonging to this TxsdVariable instance.
...
//	If the WalkHandlers.TsequenceConstructor function is not nil (ie. was set by outside code), calls it with this TsequenceConstructor instance as the single argument. Then calls the Walk() method on 2/2 embed(s) and 0/0 field(s) belonging to this TsequenceConstructor instance.
...
//	If the WalkHandlers.TxsdParam function is not nil (ie. was set by outside code), calls it with this TxsdParam instance as the single argument. Then calls the Walk() method on 1/6 embed(s) and 0/0 field(s) belonging to this TxsdParam instance.
...
//	If the WalkHandlers.TxsdTemplate function is not nil (ie. was set by outside code), calls it with this TxsdTemplate instance as the single argument. Then calls the Walk() method on 3/8 embed(s) and 0/0 field(s) belonging to this TxsdTemplate instance.
...
//	If the WalkHandlers.TxsdFunction function is not nil (ie. was set by outside code), calls it with this TxsdFunction instance as the single argument. Then calls the Walk() method on 3/6 embed(s) and 0/0 field(s) belonging to this TxsdFunction instance.
...
//	If the WalkHandlers.TxsdKey function is not nil (ie. was set by outside code), calls it with this TxsdKey instance as the single argument. Then calls the Walk() method on 1/5 embed(s) and 0/0 field(s) belonging to this TxsdKey instance.
...
func (me TyesOrNoOrOmit) IsYes() bool { return me.String() == "yes" }

//	Returns true if the value of this enumerated TyesOrNoOrOmit is "no".
func (me TyesOrNoOrOmit) IsNo() bool { return me.String() == "no" }

//	Returns true if the value of this enumerated TyesOrNoOrOmit is "omit".
func (me TyesOrNoOrOmit) IsOmit() bool { return me.String() == "omit" }
...
//	If the WalkHandlers.TxsdOutput function is not nil (ie. was set by outside code), calls it with this TxsdOutput instance as the single argument. Then calls the Walk() method on 1/18 embed(s) and 0/0 field(s) belonging to this TxsdOutput instance.
...
func (me TvalidationStripOrPreserve) IsPreserve() bool { return me.String() == "preserve" }

//	Returns true if the value of this enumerated TvalidationStripOrPreserve is "strip".
func (me TvalidationStripOrPreserve) IsStrip() bool { return me.String() == "strip" }
...
func (me TinputTypeAnnotationsType) IsPreserve() bool { return me.String() == "preserve" }

//	Returns true if the value of this enumerated TinputTypeAnnotationsType is "strip".
func (me TinputTypeAnnotationsType) IsStrip() bool { return me.String() == "strip" }

//	Returns true if the value of this enumerated TinputTypeAnnotationsType is "unspecified".
func (me TinputTypeAnnotationsType) IsUnspecified() bool { return me.String() == "unspecified" }
...
//	TxsdModesUnion declares a String containing a whitespace-separated list of TxsdModesUnionTxsdModesUnionList values. This Values() method creates and returns a slice of all elements in that list.
func (me TxsdModesUnion) Values() (list []Tmethod) {
	svals := xsdt.ListValues(string(me))
...
//	TxsdModesUnion declares a String containing a whitespace-separated list of TxsdModesUnionTxsdModesUnionList values. This Values() method creates and returns a slice of all elements in that list, typed as xsdt.String.
func (me TxsdModesUnion) ValuesXsdtString() (list []xsdt.String) {
	svals := xsdt.ListValues(string(me))
	list = make([]xsdt.String, len(svals))
	for i, s := range svals {
		list[i].Set(s)
...
func (me *TxsdModesUnionTxsdModesUnionListTxsdModesUnionTxsdModesUnionListUnion) Set(s string) {
	(*xsdt.Token)(me).Set(s)
}
...
func (me TxsdModesUnionTxsdModesUnionListTxsdModesUnionTxsdModesUnionListUnion) String() string {
...
func (me TxsdModesUnionTxsdModesUnionListTxsdModesUnionTxsdModesUnionListUnion) ToXsdtToken() xsdt.Token {
...
func (me TxsdModesUnionTxsdModesUnionListTxsdModesUnionTxsdModesUnionListUnion) IsDefault() bool {
	return me.String() == "#default"
}
...
func (me Tmethod) ToTQName() TQName { return TQName(me) }
...
func (me Tmethod) ToTxsdModesUnionTxsdModesUnionListTxsdModesUnionTxsdModesUnionListUnion() TxsdModesUnionTxsdModesUnionListTxsdModesUnionTxsdModesUnionListUnion {
	return TxsdModesUnionTxsdModesUnionListTxsdModesUnionTxsdModesUnionListUnion(me)
}
...
func (me TxsdNametestsListTxsdNametestsListUnion) Is() bool { return me.String() == "*" }
...
func (me *TxsdNametestsListTxsdNametestsListUnion) Set(s string) { (*xsdt.Token)(me).Set(s) }
...
func (me Tmethod) ToTxsdNametestsListTxsdNametestsListUnion() TxsdNametestsListTxsdNametestsListUnion {
	return TxsdNametestsListTxsdNametestsListUnion(me)
}
...
func (me Tmethod) ToTxsdNametestsListTxsdNametestsListUnion1() TxsdNametestsListTxsdNametestsListUnion1 {
	return TxsdNametestsListTxsdNametestsListUnion1(me)
}

//	Tnametests declares a String containing a whitespace-separated list of TxsdNametestsList values. This Values() method creates and returns a slice of all elements in that list.
func (me Tnametests) Values() (list []Tmethod) {
	svals := xsdt.ListValues(string(me))
...
//	Tnametests declares a String containing a whitespace-separated list of TxsdNametestsList values. This Values() method creates and returns a slice of all elements in that list, typed as xsdt.String.
func (me Tnametests) ValuesXsdtString() (list []xsdt.String) {
	svals := xsdt.ListValues(string(me))
	list = make([]xsdt.String, len(svals))
	for i, s := range svals {
		list[i].Set(s)
...
func (me *TxsdNametestsListTxsdNametestsListUnion1) Set(s string) { (*xsdt.Token)(me).Set(s) }
...
func (me *TxsdPrefixOrDefaultUnion) Set(s string) { (*xsdt.Token)(me).Set(s) }
...
func (me TxsdPrefixOrDefaultUnion) IsDefault() bool { return me.String() == "#default" }
...
func (me TprefixOrDefault) ToTxsdPrefixOrDefaultUnion() TxsdPrefixOrDefaultUnion {
	return TxsdPrefixOrDefaultUnion(me)
}

type TxsdModeUnion xsdt.Token

//	Returns true if the value of this enumerated TxsdModeUnion is "#default".
func (me TxsdModeUnion) IsDefault() bool { return me.String() == "#default" }

//	Returns true if the value of this enumerated TxsdModeUnion is "#current".
func (me TxsdModeUnion) IsCurrent() bool { return me.String() == "#current" }
...
func (me *TxsdModeUnion) Set(s string) { (*xsdt.Token)(me).Set(s) }
...
func (me TxsdModesUnion1) IsAll() bool { return me.String() == "#all" }
...
func (me Tmodes) ToTxsdModesUnion() Tmethod { return Tmethod(me) }
...
func (me *TxsdModesUnion1) Set(s string) { (*xsdt.Token)(me).Set(s) }
...
func (me TprefixListOrAll) ToTxsdPrefixListOrAllUnion() TxsdPrefixListOrAllUnion {
	return TxsdPrefixListOrAllUnion(me)
}

//	Since TxsdPrefixListOrAllUnion is just a simple String type, this merely sets the current value from the specified string.
func (me *TxsdPrefixListOrAllUnion) Set(s string) { (*xsdt.Token)(me).Set(s) }
...
func (me TxsdPrefixListOrAllUnion) IsAll() bool { return me.String() == "#all" }
...
func (me *TxsdMethodUnion) Set(s string) { (*xsdt.NCName)(me).Set(s) }
...
func (me TxsdMethodUnion) IsXml() bool { return me.String() == "xml" }

//	Returns true if the value of this enumerated TxsdMethodUnion is "xhtml".
func (me TxsdMethodUnion) IsXhtml() bool { return me.String() == "xhtml" }

//	Returns true if the value of this enumerated TxsdMethodUnion is "html".
func (me TxsdMethodUnion) IsHtml() bool { return me.String() == "html" }

//	Returns true if the value of this enumerated TxsdMethodUnion is "text".
func (me TxsdMethodUnion) IsText() bool { return me.String() == "text" }
...
func (me *TxsdMethodUnion1) Set(s string) { (*TQName)(me).Set(s) }
