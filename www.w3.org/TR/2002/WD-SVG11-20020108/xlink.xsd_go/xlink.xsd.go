// Package goXlink : autogenerated by go-xsd
package goXlink
...
// XsdGoPkgHasAttrType defines attribute Type
type XsdGoPkgHasAttrType struct {
	Type TxsdType `xml:"http://www.w3.org/1999/xlink type,attr"`
}

// TypeDefault : Returns the default value for Type -- "simple"
func (me XsdGoPkgHasAttrType) TypeDefault() TxsdType { return TxsdType("simple") }

// XsdGoPkgHasAttrHref defines attribute Href
type XsdGoPkgHasAttrHref struct {
	Href xsdt.AnyURI `xml:"http://www.w3.org/1999/xlink href,attr"`
}

// XsdGoPkgHasAttrRole defines attribute Role
type XsdGoPkgHasAttrRole struct {
	Role xsdt.String `xml:"http://www.w3.org/1999/xlink role,attr"`
}

// XsdGoPkgHasAttrArcrole defines attribute Arcrole
type XsdGoPkgHasAttrArcrole struct {
	Arcrole xsdt.String `xml:"http://www.w3.org/1999/xlink arcrole,attr"`
}

// XsdGoPkgHasAttrTitle defines attribute Title
type XsdGoPkgHasAttrTitle struct {
	Title xsdt.String `xml:"http://www.w3.org/1999/xlink title,attr"`
}

// TxsdShow defines TxsdShow
...
// XsdGoPkgHasAttrShow defines attribute Show
type XsdGoPkgHasAttrShow struct {
	Show TxsdShow `xml:"http://www.w3.org/1999/xlink show,attr"`
}

// ShowDefault : Returns the default value for Show -- "embed"
func (me XsdGoPkgHasAttrShow) ShowDefault() TxsdShow { return TxsdShow("embed") }

// TxsdActuate defines TxsdActuate
...
// XsdGoPkgHasAttrActuate defines attribute Actuate
type XsdGoPkgHasAttrActuate struct {
...
func (me XsdGoPkgHasAttrActuate) ActuateDefault() TxsdActuate { return TxsdActuate("onLoad") }

// XsdGoPkgHasAttrFrom defines attribute From
type XsdGoPkgHasAttrFrom struct {
	From xsdt.String `xml:"http://www.w3.org/1999/xlink from,attr"`
}

// XsdGoPkgHasAttrTo defines attribute To
type XsdGoPkgHasAttrTo struct {
