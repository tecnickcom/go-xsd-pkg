...
//		docs.oasis-open.org/security/saml/v2.0/saml-schema-authn-context-kerberos-2.0.xsd
package go_SamlAuthnContextKerberos20
...
type XsdGoPkgHasAttr_Method_XsdtAnyURI_UrnOasisNamesTcSaml20AcClassesKerberos struct {
	Method xsdt.AnyURI `xml:"urn:oasis:names:tc:SAML:2.0:ac:classes:Kerberos method,attr"`
}

//	Returns the fixed value for Method -- "urn:oasis:names:tc:SAML:2.0:ac:classes:Kerberos"
func (me XsdGoPkgHasAttr_Method_XsdtAnyURI_UrnOasisNamesTcSaml20AcClassesKerberos) MethodFixed() xsdt.AnyURI {
...
type TSharedSecretChallengeResponseType struct {
	*TSharedSecretChallengeResponseType
	...
	XsdGoPkgHasAttr_Method_XsdtAnyURI_UrnOasisNamesTcSaml20AcClassesKerberos
}
