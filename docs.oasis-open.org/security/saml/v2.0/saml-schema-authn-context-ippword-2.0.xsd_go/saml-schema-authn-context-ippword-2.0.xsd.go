// Package goSamlAuthnContextIppword20 : autogenerated from XSD schema and manually adjusted (Nicola Asuni - 2016-11-03)
package goSamlAuthnContextIppword20
...
type XAttrIDXsdtID struct {
	ID xsdt.ID `xml:"urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword ID,attr"`
}
