// Package goSamlAuthnContextMobileonefactorUnreg20 : autogenerated by go-xsd
package goSamlAuthnContextMobileonefactorUnreg20
...
type XsdGoPkgHasAttrMediumTxsdRedefineKeyStorageTypeComplexContentRestrictionMedium struct {
	Medium TxsdRedefineKeyStorageTypeComplexContentRestrictionMedium `xml:"urn:oasis:names:tc:SAML:2.0:ac:classes:MobileOneFactorUnregistered medium,attr"`
}

// XsdGoPkgHasAttrIDXsdtID defines attribute IdXsdtId
type XsdGoPkgHasAttrIDXsdtID struct {
	ID xsdt.ID `xml:"urn:oasis:names:tc:SAML:2.0:ac:classes:MobileOneFactorUnregistered ID,attr"`
}
...
type XsdGoPkgHasAttrNymTxsdRedefineIdentificationTypeComplexContentRestrictionNym struct {
	Nym TxsdRedefineIdentificationTypeComplexContentRestrictionNym `xml:"urn:oasis:names:tc:SAML:2.0:ac:classes:MobileOneFactorUnregistered nym,attr"`
}
