...
//		docs.oasis-open.org/security/saml/v2.0/saml-schema-authn-context-mobileonefactor-reg-2.0.xsd
package go_SamlAuthnContextMobileonefactorReg20
...
//	If the WalkHandlers.TAuthenticatorBaseType function is not nil (ie. was set by outside code), calls it with this TAuthenticatorBaseType instance as the single argument. Then calls the Walk() method on 1/8 embed(s) and 0/0 field(s) belonging to this TAuthenticatorBaseType instance.
...
//	Returns true if the value of this enumerated TxsdRedefineIdentificationTypeComplexContentRestrictionNym is "verinymity".
...
//	If the WalkHandlers.TPrivateKeyProtectionType function is not nil (ie. was set by outside code), calls it with this TPrivateKeyProtectionType instance as the single argument. Then calls the Walk() method on 1/3 embed(s) and 0/0 field(s) belonging to this TPrivateKeyProtectionType instance.
...
//	If the WalkHandlers.TSecretKeyProtectionType function is not nil (ie. was set by outside code), calls it with this TSecretKeyProtectionType instance as the single argument. Then calls the Walk() method on 1/3 embed(s) and 0/0 field(s) belonging to this TSecretKeyProtectionType instance.
...
type TIdentificationType struct {
	...
	*TIdentificationType
	...
	sac.XsdGoPkgHasElem_PhysicalVerification

	sac.XsdGoPkgHasElem_WrittenConsent

	sac.XsdGoPkgHasElem_GoverningAgreements
}

//	If the WalkHandlers.TIdentificationType function is not nil (ie. was set by outside code), calls it with this TIdentificationType instance as the single argument. Then calls the Walk() method on 1/6 embed(s) and 0/0 field(s) belonging to this TIdentificationType instance.
