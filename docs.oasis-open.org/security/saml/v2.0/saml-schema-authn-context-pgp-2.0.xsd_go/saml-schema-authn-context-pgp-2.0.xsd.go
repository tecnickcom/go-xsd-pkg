...
//		docs.oasis-open.org/security/saml/v2.0/saml-schema-authn-context-pgp-2.0.xsd
package go_SamlAuthnContextPgp20
...
type XsdGoPkgHasAttr_KeyValidation_XsdtString_UrnOasisNamesTcSaml20AcClassesPgp struct {
	KeyValidation xsdt.String `xml:"urn:oasis:names:tc:SAML:2.0:ac:classes:PGP keyValidation,attr"`
}

//	Returns the fixed value for KeyValidation -- "urn:oasis:names:tc:SAML:2.0:ac:classes:PGP"
func (me XsdGoPkgHasAttr_KeyValidation_XsdtString_UrnOasisNamesTcSaml20AcClassesPgp) KeyValidationFixed() xsdt.String {
	return xsdt.String("urn:oasis:names:tc:SAML:2.0:ac:classes:PGP")
}

type TPublicKeyType struct {
	*TPublicKeyType

	XsdGoPkgHasAttr_KeyValidation_XsdtString_UrnOasisNamesTcSaml20AcClassesPgp
}
