...
//		docs.oasis-open.org/security/saml/v2.0/saml-schema-authn-context-xmldsig-2.0.xsd
package go_SamlAuthnContextXmldsig20
...
type XsdGoPkgHasAttr_KeyValidation_XsdtAnyURI_UrnIetfRfc3075 struct {
	KeyValidation xsdt.AnyURI `xml:"urn:oasis:names:tc:SAML:2.0:ac:classes:XMLDSig keyValidation,attr"`
}

//	Returns the fixed value for KeyValidation -- "urn:ietf:rfc:3075"
func (me XsdGoPkgHasAttr_KeyValidation_XsdtAnyURI_UrnIetfRfc3075) KeyValidationFixed() xsdt.AnyURI {
...
type TPublicKeyType struct {
	*TPublicKeyType
	...
	XsdGoPkgHasAttr_KeyValidation_XsdtAnyURI_UrnIetfRfc3075
}
