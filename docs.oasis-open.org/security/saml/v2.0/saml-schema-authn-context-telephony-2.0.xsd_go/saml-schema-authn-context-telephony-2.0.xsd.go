...
//		docs.oasis-open.org/security/saml/v2.0/saml-schema-authn-context-telephony-2.0.xsd
package go_SamlAuthnContextTelephony20
...
type TAuthnContextDeclarationBaseType struct {
	...
	*TAuthnContextDeclarationBaseType
	...
	sact.XsdGoPkgHasElem_Identification

	sact.XsdGoPkgHasElem_TechnicalProtection

	sact.XsdGoPkgHasElem_OperationalProtection

	sact.XsdGoPkgHasElem_AuthnMethod

	sact.XsdGoPkgHasElem_GoverningAgreements
}
