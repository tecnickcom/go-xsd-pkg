// Package goSamlAuthnContextTelephony20 : autogenerated from XSD schema and manually adjusted (Nicola Asuni - 2016-11-03)
...
type TAuthnContextDeclarationBaseType struct {
	...
	*TAuthnContextDeclarationBaseType
	sact.XElemIdentification
	sact.XElemTechnicalProtection
	sact.XElemOperationalProtection
	sact.XElemAuthnMethod
	sact.XElemGoverningAgreements
}
