// Package goSamlAuthnContextTelephony20 : autogenerated by go-xsd
package goSamlAuthnContextTelephony20
...
type XsdGoPkgHasAttrIDXsdtID struct {
	ID xsdt.ID `xml:"urn:oasis:names:tc:SAML:2.0:ac:classes:Telephony ID,attr"`
}
...
type TAuthnContextDeclarationBaseType struct {
	...
	*TAuthnContextDeclarationBaseType
	...
	sact.XsdGoPkgHasElemIdentification

	sact.XsdGoPkgHasElemTechnicalProtection

	sact.XsdGoPkgHasElemOperationalProtection

	sact.XsdGoPkgHasElemAuthnMethod

	sact.XsdGoPkgHasElemGoverningAgreements
}
