...
//		docs.oasis-open.org/security/saml/v2.0/saml-schema-authn-context-session-2.0.xsd
package go_SamlAuthnContextSession20
...
type TAuthenticatorBaseType struct {
	*TAuthenticatorBaseType
	...
	sac.XsdGoPkgHasElem_PreviousSession
}
