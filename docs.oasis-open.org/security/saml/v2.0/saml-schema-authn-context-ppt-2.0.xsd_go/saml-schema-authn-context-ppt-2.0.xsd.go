// Package goSamlAuthnContextPpt20 : autogenerated by go-xsd
package goSamlAuthnContextPpt20
...
type XsdGoPkgHasAttrIDXsdtID struct {
	ID xsdt.ID `xml:"urn:oasis:names:tc:SAML:2.0:ac:classes:PasswordProtectedTransport ID,attr"`
}
