// Package goSamlAuthnContextMobiletwofactorReg20 : autogenerated by go-xsd
...
type XsdGoPkgHasAttrNymTxsdRedefineIdentificationTypeComplexContentRestrictionNym struct {
	Nym TxsdRedefineIdentificationTypeComplexContentRestrictionNym `xml:"urn:oasis:names:tc:SAML:2.0:ac:classes:MobileTwoFactorContract nym,attr"`
}
...
type XsdGoPkgHasAttrMediumTxsdRedefineKeyStorageTypeComplexContentRestrictionMedium struct {
	Medium TxsdRedefineKeyStorageTypeComplexContentRestrictionMedium `xml:"urn:oasis:names:tc:SAML:2.0:ac:classes:MobileTwoFactorContract medium,attr"`
}
...
type TIdentificationType struct {
	sac.XsdGoPkgHasElemPhysicalVerification

	sac.XsdGoPkgHasElemWrittenConsent
...
type XsdGoPkgHasAttrIDXsdtID struct {
	ID xsdt.ID `xml:"urn:oasis:names:tc:SAML:2.0:ac:classes:MobileTwoFactorContract ID,attr"`
}
