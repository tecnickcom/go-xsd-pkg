// Package goSamlAuthnContextAuthTelephony20 : autogenerated by go-xsd
package goSamlAuthnContextAuthTelephony20
...
type XsdGoPkgHasAttrIDXsdtID struct {
	ID xsdt.ID `xml:"urn:oasis:names:tc:SAML:2.0:ac:classes:AuthenticatedTelephony ID,attr"`
}
...
type TAuthenticatorBaseType struct {
	*TAuthenticatorBaseType
	...
	sac.XsdGoPkgHasElemSubscriberLineNumber

	sac.XsdGoPkgHasElemUserSuffix
}

// Walk : if the WalkHandlers.TAuthenticatorBaseType function is not nil (ie. was set by outside code), calls it with this TAuthenticatorBaseType instance as the single argument. Then calls the Walk() method on 1/4 embed(s) and 0/0 field(s) belonging to this TAuthenticatorBaseType instance.
...
type TAuthenticatorTransportProtocolType struct {
	*TAuthenticatorTransportProtocolType
	...
	sac.XsdGoPkgHasElemPstn

	sac.XsdGoPkgHasElemIsdn

	sac.XsdGoPkgHasElemAdsl
...
var (
	...
	// WalkHandlers Provides 5 strong-typed hooks for your own custom handler functions to be invoked when the Walk() method is called on any instance of any (non-attribute-related) struct type defined in this package.
	// If your custom handler does get called at all for a given struct instance, then it always gets called twice, first with the 'enter' bool argument set to true, then (after having Walk()ed all subordinate struct instances, if any) once again with it set to false.
	WalkHandlers = &XsdGoPkgWalkHandlers{}
)

// XsdGoPkgWalkHandlers Provides 5 strong-typed hooks for your own custom handler functions to be invoked when the Walk() method is called on any instance of any (non-attribute-related) struct type defined in this package.
// If your custom handler does get called at all for a given struct instance, then it always gets called twice, first with the 'enter' bool argument set to true, then (after having Walk()ed all subordinate struct instances, if any) once again with it set to false.
